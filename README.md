...
### 📊 Overview Page
Command-center view with 10 top-level KPIs and a snapshot of every downstream page.

<img src="assets/dashboard-overview.png" alt="Samsung Dashboard - Overview Page" width="850"/>

<br/><br/>

### 🏭 Supplier Page
Procurement spend, lead time, and quality score performance by supplier.

<img src="assets/dashboard-supplier.png" alt="Samsung Dashboard - Supplier Page" width="850"/>

<br/><br/>

### 📦 Inventory & Production Page
Stock health, defect rate, and reorder point tracking by product.

<img src="assets/dashboard-inventory.png" alt="Samsung Dashboard - Inventory & Production Page" width="850"/>

<br/><br/>

### 🚚 Shipment Page
Carrier performance, delay reasons, and delivery status across the logistics network.

<img src="assets/dashboard-shipment.png" alt="Samsung Dashboard - Shipment Page" width="850"/>
...
<img src="assets/data-model.png" alt="Samsung Dashboard - Star Schema Data Model" width="850"/>
...
└── assets/
    ...
    ├── dashboard-supplier.png
    ├── dashboard-inventory.png
    ├── dashboard-shipment.png
